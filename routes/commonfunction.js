...
/*
 * ----------------------------------------------------------------------------------------------------------------------------------------
 * Add data into history table
 * INPUT : Table name,Alteration_id, Action, Created_on
 * ----------------------------------------------------------------------------------------------------------------------------------------
 */
exports.setHistory = function(tablename,alterationId,action,created_on){
    var sql = 'insert into history(table_name,alteration_id,action,created_on) values(?,?,?,?)';
    var values = [tablename,alterationId,action,created_on];
    connection.query(sql,values,function(err1,res1){
        if(err1){
            var msg = 'Error while adding data into History Table';
